...
```{r}
sp_glm= glm(Drypetes.standleyi~ Cordia.lasiocalyx +  Hirtella.triandra + Picramnia.latifolia + Quassia.amara + Tabernaemontana.arborea + Trattinnickia.aspera + Xylopia.macrantha, data = predict_sp, family = 'poisson')
...
```{r}
tratt_glm= glm(Drypetes.standleyi~  Trattinnickia.aspera, data = predict_sp, family = 'poisson')
